...
class EatValue extends StatefulWidget {
  ...
  @override
  State<EatValue> createState() => _EatValue();
}

class _EatValue extends State<EatValue> {
              ...
              child: GestureDetector(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(widget.icons[index], color: Colors.white, size: 40),
                      Text(
                        widget.labels[index],
